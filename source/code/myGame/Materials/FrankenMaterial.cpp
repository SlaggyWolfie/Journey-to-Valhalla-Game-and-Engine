...
ShaderProgram* FrankenMaterial::_shader = NULL;

GLint FrankenMaterial::_uDiffuseTexture0 = 0;
GLint FrankenMaterial::_uDiffuseTexture1 = 0;
GLint FrankenMaterial::_uDiffuseTexture2 = 0;
GLint FrankenMaterial::_uDiffuseTexture3 = 0;

GLint FrankenMaterial::_uHeightmap = 0;
GLint FrankenMaterial::_uSplatmap = 0;

GLint FrankenMaterial::_uTerrainHeight = 0;
GLint FrankenMaterial::_uTerrainWidth = 0;
GLint FrankenMaterial::_uTerrainLength = 0;

GLint FrankenMaterial::_uNumberOfDirectionalLights = 0;
GLint FrankenMaterial::_uNumberOfPointLights = 0;
GLint FrankenMaterial::_uNumberOfSpotLights = 0;

//GLint FrankenMaterial::_uVertexLit = 0;

GLint FrankenMaterial::_uModelMatrix = 0;
GLint FrankenMaterial::_uViewMatrix = 0;
GLint FrankenMaterial::_uProjectionMatrix = 0;

GLint FrankenMaterial::_uDiffuseColor = 0;
GLint FrankenMaterial::_uAmbientTerm = 0;
GLint FrankenMaterial::_uAmbientContribution = 0;
GLint FrankenMaterial::_uAttenuationConstants = 0;
GLint FrankenMaterial::_uSpecularColor = 0;
GLint FrankenMaterial::_uCameraPosition = 0;

GLint FrankenMaterial::_uShininess = 0;
GLint FrankenMaterial::_uTime = 0;

GLint FrankenMaterial::_aVertex = 0;
GLint FrankenMaterial::_aNormal = 0;
GLint FrankenMaterial::_aUV = 0;

sf::Clock FrankenMaterial::_clock = sf::Clock();

FrankenMaterial::FrankenMaterial(
...
void FrankenMaterial::_lazyInitializeShader() {
	if (!_shader) {
		_shader = new ShaderProgram();
		_shader->addShader(GL_VERTEX_SHADER, MyGame::SHADER_PATH + "frankenstein.vs");
		_shader->addShader(GL_FRAGMENT_SHADER, MyGame::SHADER_PATH + "frankenstein.fs");
...
void FrankenMaterial::setDiffuseColor(glm::vec3 pDiffuseColor)
{
	_diffuseColor = pDiffuseColor;
}

glm::vec3 FrankenMaterial::getDiffuseColor()
{
	return _diffuseColor;
}

//void FrankenMaterial::setDiffuseTexture(Texture * texture)
//{
//	_diffuseTexture = texture;
//}
//Texture * FrankenMaterial::getDiffuseTexure()
//{
//	return _diffuseTexture;
//}

void FrankenMaterial::setSpecularColor(glm::vec3 specularColor)
{
	_specularColor = specularColor;
}
glm::vec3 FrankenMaterial::getSpecularColor()
{
	return _specularColor;
}
void FrankenMaterial::setSpecularStrength(float specularStrength)
{
	_specularStrength = specularStrength;
}
float FrankenMaterial::getSpecularStrength()
{
	return _specularStrength;
}
void FrankenMaterial::setShininess(float shininess)
{
	_shininess = shininess;
}
float FrankenMaterial::getShininess()
{
	return _shininess;
}

void FrankenMaterial::setShaderLitType(ShaderLit litType)
{
	_shaderLitType = litType;
}

void FrankenMaterial::setShaderLitType(int litType)
{
	_shaderLitType = (FrankenMaterial::ShaderLit)litType;
}

FrankenMaterial::ShaderLit FrankenMaterial::getShaderLitType()
{
	return _shaderLitType;
}

void FrankenMaterial::render(World* pWorld, Mesh* pMesh,
