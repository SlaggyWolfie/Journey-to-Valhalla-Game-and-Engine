...
namespace MyGame
{
	...
	FifthScene::FifthScene() :AbstractGame(), _hud(0)
	{
	}

	void FifthScene::initialize() {
		//setup the core part
	...
	void FifthScene::_initializeScene()
	{
		//MESHES
		...
		//AbstractMaterial* lightMat = new ColorMaterial(glm::vec3(1, 0, 0));
		//Light* light = new Light("Red Light", glm::vec3(0, 2, 0));
		//light->setBehaviour(new ElevationBehaviour(15));
		//light->setColor(glm::vec3(1, 0, 0));

		//landLitMat->setShaderLitType(LitMaterial::ShaderLit::Vertex);
		landLitMat->setShininess(32);
		...
		//lightMat->setDiffuseColor(glm::vec3(1, 1, 1));
	...
	void FifthScene::_render() {
		AbstractGame::_render();
		_updateHud();
	}

	void FifthScene::_updateHud() {
