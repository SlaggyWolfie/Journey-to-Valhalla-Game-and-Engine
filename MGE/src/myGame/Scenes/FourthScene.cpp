...
namespace MyGame
{
	...
	FourthScene::FourthScene() :AbstractGame(), _hud(0)
	{
	}
	...
	void FourthScene::_initializeScene()
	{
		//MESHES
		...
		AbstractMaterial* runicStoneMaterialWobbling = new WobbleMaterial(Texture::load(config::MGE_TEXTURE_PATH + "runicfloor.png"));
		...
		sphere->setMaterial(runicStoneMaterialWobbling);
	...
	void FourthScene::_render() {
		AbstractGame::_render();
		_updateHud();
	}

	void FourthScene::_updateHud() {
