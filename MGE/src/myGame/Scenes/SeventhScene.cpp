...
namespace MyGame
{
	...
	SeventhScene::SeventhScene() :AbstractGame(), _hud(0)
	{
	}

	void SeventhScene::initialize() {
		//setup the core part
	...
	void SeventhScene::_initializeScene()
	{
		//MESHES
		...
		LitMaterial* teapotMat = new LitMaterial(LitMaterial::ShaderLit::Fragment, glm::vec3(0.5f));
		LitMaterial* suzannaMat = new LitMaterial(LitMaterial::ShaderLit::Fragment, glm::vec3(0, 0, 1));
		...
		LitTextureMaterial* brickLitMat = new LitTextureMaterial(Texture::load(config::MGE_TEXTURE_PATH + "bricks.jpg"));
		//TextureMaterial* brickLitMat = new TextureMaterial(Texture::load(config::MGE_TEXTURE_PATH + "bricks.jpg"));
		brickLitMat->setSpecularStrength(1);
		brickLitMat->setShininess(1000);
		teapotMat->setSpecularStrength(1);
		teapotMat->setShininess(50);
		suzannaMat->setSpecularStrength(1);
		suzannaMat->setShininess(50);
	...
	void SeventhScene::_render() {
		AbstractGame::_render();
		_updateHud();
	}

	void SeventhScene::_updateHud() {
